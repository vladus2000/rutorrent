...
RUN \
	...
	pacman -S --needed --noconfirm python-pip python-asn1crypto python-brotli python-cffi python-cryptography python-js2py python-pycparser python-pyopenssl python-tzlocal && \
